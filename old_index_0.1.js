...
HistoryBuffSkill.prototype.intentHandlers = {
	"GetStockPrice": function(intent,session,response) {
		GetStockPrice(intent,session,response);
	},
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        var speechText = "Get Stock Info?";
        var repromptText = "Which stock?";
        var speechOutput = {
            speech: speechText,
...
function getWelcomeResponse(response) {
    ...
    var cardTitle = "Welcome to AlexaStocks";
    var repromptText = "Welcome to AlexaStocks";
    var speechText = "<p>AlexaStocks</p> <p>What stock?</p>";
    var cardOutput = "Alexa Stocks. What stock?";
...
function GetStockPrice(intent,session, response) {
	...
	var repromptText = "Please go again!";
...
function handleFirstEventRequest(intent, session, response) {
    ...
    var repromptText = "First Request Handler";
